package com.legacyapp.LogQuickSearchData;

import android.content.Context;

import com.legacyapp.Utils.AppActivity;
...
public class LogQuickSearch extends Model {
    ...
    public static List<LogQuickSearch> logSortByProjectType(String Key_) {
        ...
        return LogQuickSearch.objects().filter(filter).orderBy("Object_name").toList();
    ...
    public static List<LogQuickSearch> FilterByName(String name) {
        Filter filter = new Filter();
        filter.contains("Object_name", name);
        return LogQuickSearch.objects().filter(filter).orderBy("Object_name").toList();
    }
