...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, Camera camera) {
        ...
        System.out.println("tjhbse==========="+getHolder().getSurfaceFrame());
    }
    ...
    public void surfaceCreated(SurfaceHolder holder)
    {
        try
        {
            System.out.println("plmkoijbhuygvcftrdx=="+holder.getSurfaceFrame());
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h)
    {
        ...
        System.out.println("Hello1234567890");
        try {
            ...
            mCamera.startPreview();
            System.out.println("Hello1234567890ttttttttttttttttttttttttttttttttt");
    ...
    private Camera.PreviewCallback mPreviewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
        	...
        	/*if(data!=null)
        	{
        		System.out.println("asdgafafhadfj");
        		data=null;
        		//result=null;
        	}*/
