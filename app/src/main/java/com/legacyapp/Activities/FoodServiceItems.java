...
public class FoodServiceItems extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_service_items);
        ...
        CustomListViewAdapter adapter = new CustomListViewAdapter(this, R.layout.food_service_items, rowItems);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(FoodServiceItems.this, Productview.class);
                i.putExtra("key", txt);
