...
public class TechnologyItems extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.technology_items);
       ...
       /* for (int i = 0; i < titles.length; i++) {
        ...
        CustomListViewAdapter adapter = new CustomListViewAdapter(this, R.layout.technology_items, rowItems);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(TechnologyItems.this, Productview.class);
                i.putExtra("key", txt);
