...
public class HealthCare extends Fragment {
    ...
    int images[]={R.drawable.dietary,R.drawable.housekeeping,R.drawable.infectioncontrol,R.drawable.restroom,R.drawable.maintenance,R.drawable.nursing};


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.health_care, container, false);
        context = getActivity();
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                i.putExtra("url", url);
                i.putExtra("image",R.drawable.healthcare_full);
