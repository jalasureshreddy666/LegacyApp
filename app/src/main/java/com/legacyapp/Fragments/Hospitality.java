...
public class Hospitality extends Fragment {
    ...
    int images[]={R.drawable.hotelslodging,R.drawable.countryclubs,R.drawable.entertainment_rec,R.drawable.gyms};

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.hospitality,container,false);
        context = getActivity();

        expandableListView=(ExpandableListView)v.findViewById(R.id.expandableListViewHospitality);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,int groupPosition, int childPosition, long id) {
               ...
               /* Intent i = new Intent(getActivity(), HospitalityItems.class);
                startActivity(i);*/
                ...
                i.putExtra("url",url);
                i.putExtra("image",R.drawable.hospitality_full);
    ...
    private class GetDataList extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            expandableListAdapter = new ExpandableListAdapter(getActivity(), expandableListTitle, expandableListDetail,images);
