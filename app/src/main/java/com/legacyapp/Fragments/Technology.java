...
public class Technology extends Fragment {
    ...
    int images[]={R.drawable.aerospace,R.drawable.pharma,R.drawable.microprocessing,R.drawable.labortoryrd};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        expandableListView=(ExpandableListView)v.findViewById(R.id.expandableListViewTechnology);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,int groupPosition, int childPosition, long id) {
              ...
              /*  Intent i = new Intent(getActivity(), TechnologyItems.class);
                startActivity(i);*/
                ...
                i.putExtra("url",url);
                i.putExtra("image",R.drawable.technology_full);
