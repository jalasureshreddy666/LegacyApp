 ...
 */
public class FoodService extends Fragment {
    ...
    int imagesfood[]={R.drawable.restaurant_new,R.drawable.food_processing_new,R.drawable.foodfeeder_new,R.drawable.catering_new,R.drawable.cafeteria_new};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.food_service,container,false);
        context = getActivity();

        expandableListView=(ExpandableListView)v.findViewById(R.id.expandableListViewFoodService);
       ...
       /* expandableListAdapter = new ExpandableListAdapter(getActivity(), expandableListTitle, expandableListDetail);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,int groupPosition, int childPosition, long id) {
                ...
                i.putExtra("url",url);
                i.putExtra("image",R.drawable.foodservice_full);
    ...
    private class GetDataList extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            expandableListAdapter = new ExpandableListAdapter(getActivity(), expandableListTitle, expandableListDetail ,imagesfood);
            expandableListView.setAdapter(expandableListAdapter);
